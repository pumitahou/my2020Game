...
def main():
    ...
    while Init_Menu == True:
        ...
        particleManager.Particle_Spawn_Rv(5, 1000, random.randint(0, Windows_X), random.randint(0, Windows_Y), random.randint(0, 40), random.randint(0, 40), random.randint(0, 40), -1, -1, 1, 1, random.randint(1, 4))
        ...
        while CB_3:
            ...
            for i in range(Lana_Count()):
                ...
                if distance(Mouse_Pos_X_Lana, Mouse_Pos_Y_Lana, X_L, Y_L) < R:
                    Damage_Lana(N, 10)
                    # 1, 300, Mouse_Pos_X_Lana, Mouse_Pos_Y_Lana, random.randint(200, 240), random.randint(200, 240), random.randint(200, 240), -1, -3, 1, 0.2, random.randint(int(R / 16), int(R / 2))
                    particleManager.Particle_Spawn_Rv(1, 300, Mouse_Pos_X_Lana, Mouse_Pos_Y_Lana, random.randint(200, 240), random.randint(200, 240), random.randint(200, 240), -1, -3, 1, 0.2, random.randint(int(R / 16), int(R / 2)))
